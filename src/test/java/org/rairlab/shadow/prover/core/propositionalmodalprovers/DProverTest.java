...
public class DProverTest {
    ...
    public Object[][] completenessTestsProvider() throws Reader.ParsingException {
        ...
        List<Problem > tests = ProblemReader.readFrom(Sandbox.class.getResourceAsStream("D-completness-tests.clj"));
    ...
    public Object[][] soundnessTestsProvider() throws Reader.ParsingException {
        ...
        List<Problem >tests = ProblemReader.readFrom(Sandbox.class.getResourceAsStream("T-soundness-tests.clj"));
        Object[][] cases =  new Object[tests.size()][2];
